...
Namespace dataibadah

    Public Class jadwalsholat_context
        ...
        Public tabel_jadwal As Table(Of tb_jadwal_sholat)
    ...
    <Table()>
    Public Class tb_jadwal_sholat

        <Column(IsPrimaryKey:=True, IsDbGenerated:=True, DbType:="INT NOT NULL Identity", CanBeNull:=False, AutoSync:=AutoSync.OnInsert)>
        Public f_id As Integer

        <Column()>
        Public f_bulan As Integer

        <Column()>
        Public f_tanggal As Integer

        <Column()>
        Public w_imsak As Integer

        <Column()>
        Public w_subuh As Integer

        <Column()>
        Public w_terbit As Integer

        <Column()>
        Public w_dhuha As Integer

        <Column()>
        Public w_dzuhur As Integer

        <Column()>
        Public w_ashr As Integer

        <Column()>
        Public w_maghrib As Integer

        <Column()>
        Public w_isya As Integer
    End Class
    ...
    Public Class dataibadah_context
        ...
        ' Specify a table for the to-do items.
        Public tabel_data_harian As Table(Of tb_ibadah_harian)
